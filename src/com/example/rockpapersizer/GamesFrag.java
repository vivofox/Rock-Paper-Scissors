...
public class GamesFrag extends Fragment implements OnItemClickListener{
	...
	public static GamesFrag newInstance(String userName){
		
		GamesFrag frag = new GamesFrag();
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if (game.getGameResult().equals("waiting") ) {
			...
			AlertDialog dialog = new AlertDialog.Builder(getActivity())
					.setCancelable(true)
					.setMessage("please select your hand")
					.setPositiveButton("Rock", listener)
					.setNegativeButton("Paper", listener)
					.setNeutralButton("Scissors", listener)
					.create();
	...
	class PutTask extends AsyncTask<Void, Void, String>{
		...
		protected String doInBackground(Void... params) {
			...
			return put(API , new String[]{"gameId" , gameId+"",  "gustHand", gustHandRestponse+"" , "reqAction" , "setResultFinish"});
		}
